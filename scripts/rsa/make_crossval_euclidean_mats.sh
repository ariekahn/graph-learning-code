...
OUTPUT_DIR=$PROJECT_DIR/derived/crossval_euclidean_mats-${DATE}
mkdir -p $OUTPUT_DIR
...
MEMORY_GB=15.0
# Output script name
SCRIPT_BASE_NAME=crossval_euclidean_mats.sh
...
python $PROJECT_DIR/scripts/rsa/crossval_euclidean_mats.py $subject $PROJECT_DIR $OUTPUT_DIR/sub-$subject
