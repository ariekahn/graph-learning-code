...
OUTPUT_DIR=$PROJECT_DIR/derived/mvpa_classifier-${DATE}
mkdir -p $OUTPUT_DIR
...
MEMORY_GB=6.0
# Output script name
SCRIPT_BASE_NAME=mvpa_classifier.sh
...
python $PROJECT_DIR/scripts/mvpa/mvpa_classifier.py $subject $PROJECT_DIR $OUTPUT_DIR/sub-$subject $N_CORES
