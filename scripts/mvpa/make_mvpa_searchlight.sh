...
OUTPUT_DIR=$PROJECT_DIR/derived/mvpa_searchlight-${DATE}
mkdir -p $OUTPUT_DIR
...
MEMORY_GB=30.0
# Output script name
SCRIPT_BASE_NAME=mvpa_searchlight.sh
...
python $PROJECT_DIR/scripts/mvpa/mvpa_searchlight.py $subject $PROJECT_DIR $OUTPUT_DIR/sub-$subject $N_CORES
