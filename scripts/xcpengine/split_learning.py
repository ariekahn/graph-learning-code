...
for run in range(1, 6):
    ...
    original_file = f'{fmriprep_dir}/sub-{subject_id}/ses-1/func/sub-{subject_id}_ses-1_task-graphlearning_run-{run}_space-MNI152NLin6Asym_res-2_desc-preproc_bold.nii.gz'
    split_file = f'{fmriprep_dir}/sub-{subject_id}/ses-1/func/sub-{subject_id}_ses-1_task-graphlearning_run-{run}_space-MNI152NLin6Asym_res-2_desc-preproc_bold_split-learning.nii.gz'
